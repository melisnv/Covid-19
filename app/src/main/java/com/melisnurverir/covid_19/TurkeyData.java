...
public class TurkeyData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turkey_data);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(TurkeyData.this,MainActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        details_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(TurkeyData.this, Articles.class);
                startActivity(i);
                finish();
            }
        });
